            ...
            if(isset($_POST['btnAdd'])){
                ...
                if($flagCheck){
                    ...
                    if(isset($_SESSION['errorAdd'])){
                      ...
                      //  start  kiem tra danh mục da co sp này chưa
                        $issetDM=[];
                        $dmHL=[];
                      ...
                      //  end  kiem tra danh mục da co sp này chưa
                    
                    //  start  kiem tra nha cung cap da co sp này chưa
                        $issetNCC=[];
                        $nccHL=[];
                ...
                //  end  kiem tra nha cung cap da co sp này chưa

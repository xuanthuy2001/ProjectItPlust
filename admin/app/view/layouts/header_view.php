    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?=  route('nha_cung_cap','index') ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?=  route('san_pham','index') ?>">
                <i class="fas fa-fw fa-cog"></i>
                <span>Quản lý tin tức-bài viết</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="<?=  route('san_pham','index') ?>">
                <i class="fas fa-fw fa-cog"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">hello - <?=  $_SESSION["username"] ?></span>

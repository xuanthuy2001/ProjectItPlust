        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__left">
                                    <p>Showing 1–<?=  $limit ?> of <?=  $totalItems ?> results</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="row">
                        <?php  foreach($listSp as $val): ?>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg='<?=  PATH_IMAGE_CLIENT_PRODUCT.$val["image"] ?>' style='background-image: url("<?=  PATH_IMAGE_CLIENT_PRODUCT.$val["image"] ?>")' >
